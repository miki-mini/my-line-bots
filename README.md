...
| アイコン | 名前 | 機能 | ファイル |
| :---: | :--- | :--- | :--- |
| <img src="images/fox.png" width="40"> | **キツネくんの動画要約🦊**<br>(Fox Teacher) | **YouTube動画要約 & 検索**<br>動画の内容をAIが解説し、Google検索で補足情報を教えてくれます。 | [fox.py](fox.py)<br>[説明書を読む](fox.md) |
| <img src="images/frog.jpg" width="40"> | **☀️カエルくんのお天気予報🐸**<br>(Weather Frog) | **天気予報 & Googleマップ**<br>毎朝のお天気と服装情報通知＋位置情報から天気や周辺情報を教えてくれます。 | *Coming Soon...* |
...
| <img src="images/capybara.jpg" width="40"> | **AIトピックのカピバラ解説**<br>(Capybara News) | **AIニュース要約**<br>毎朝、最新のAIニュースを要約して届けてくれます。 | *Coming Soon...* |
...
| <img src="images/whale.jpg" width="40"> | **星くじらからの光の便り🐋💫**<br>(Station Master Mole) | **天体観測**<br>ジェイムズ・ウェッブの写真をLINEに送信してくれます。 | *Coming Soon...* |
