...
| <img src="images/bat.jpg" width="40"> | **コウモリの番組お知らせ🦇**<br>(TV Bat)<br> | **TV番組検索 & 通知**<br>「ジブリやる？」で検索。見たい番組を登録すると自動で通知します。スクレイピング不使用。 | [🐍 Python](bat.py)<br>[📜 説明書](bat.md)<br>[📘 Zenn](https://zenn.dev/miki_mini/articles/a70b65b67b5c93) |
